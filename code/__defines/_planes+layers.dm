...
#define DEFAULT_PLANE				0
	...
	//Above turf
	#define DECAL_LAYER                 2.01
	#define RUNE_LAYER                  2.02
	#define ABOVE_TILE_LAYER            2.03
	#define EXPOSED_PIPE_LAYER          2.04
	#define EXPOSED_WIRE_LAYER          2.05
	#define EXPOSED_WIRE_TERMINAL_LAYER 2.06
	#define BLOOD_LAYER                 2.07
	#define MOUSETRAP_LAYER             2.08
	#define PLANT_LAYER                 2.09
	//Hiding mob
	#define HIDING_MOB_LAYER 2.10
	//Below object
	#define BELOW_DOOR_LAYER        2.11
	#define OPEN_DOOR_LAYER         2.12
	#define BELOW_TABLE_LAYER       2.13
	#define TABLE_LAYER             2.14
	#define BELOW_OBJ_LAYER         2.15
	//Object
	...
	#define MOB_LAYER 				4
	//Above human
	#define ABOVE_HUMAN_LAYER  		4.01
	#define VEHICLE_LOAD_LAYER 		4.02
	#define CAMERA_LAYER       		4.03
	//Blob
	#define BLOB_SHIELD_LAYER		4.05
	#define BLOB_NODE_LAYER			4.06
	#define BLOB_CORE_LAYER			4.07
	//Effects below lighting
	#define BELOW_PROJECTILE_LAYER  4.08
	#define FIRE_LAYER              4.09
	#define PROJECTILE_LAYER        4.10
	#define ABOVE_PROJECTILE_LAYER  4.11
	#define SINGULARITY_LAYER       4.12
	#define POINTER_LAYER           4.13
...
#define OBFUSCATION_PLANE 4
	#define OBFUSCATION_LAYER           0
...
#define HUD_PLANE                       6 // For the Head-Up Display
