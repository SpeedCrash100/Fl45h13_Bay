...
#define BOMBCAP_DVSTN_RADIUS (BOMBCAP_LIGHT_RADIUS/4)
#define BOMBCAP_HEAVY_RADIUS (BOMBCAP_LIGHT_RADIUS/2)
#define BOMBCAP_LIGHT_RADIUS GLOB.max_explosion_range
#define BOMBCAP_FLASH_RADIUS (BOMBCAP_LIGHT_RADIUS*1.5)
