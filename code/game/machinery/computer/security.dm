...
/obj/machinery/computer/secure_data//TODO:SANITY
	...
	light_color = "#a91515"
	req_one_access = list(GLOB.access_security, GLOB.access_forensics_lockers, GLOB.access_lawyer)
...
<th>Criminal Status</th>
				...
				if(3.0)
					...
					if ((istype(active1, /datum/data/record) && data_core.general.Find(active1)))
						send_rsc(user, active1.fields["photo_front"], "front.png")
						send_rsc(user, active1.fields["photo_side"], "side.png")
...
//RECORD DELETE
			...
			if ("Add Entry")
				...
				while(active2.fields[text("com_[]", counter)])
					counter++
				active2.fields[text("com_[counter]")] = text("Made by [authenticated] ([rank]) on [time2text(world.realtime, "DDD MMM DD")] [stationtime2text()], [GLOB.game_year]<BR>[t1]")
