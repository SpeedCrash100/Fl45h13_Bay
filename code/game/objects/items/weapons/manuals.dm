...
/obj/item/weapon/book/manual/engineering_construction/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[GLOB.config.wikiurl]Guide_to_construction&printable=yes&remove_links=1" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/engineering_hacking/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[GLOB.config.wikiurl]Hacking&printable=yes&remove_links=1" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/security_space_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[GLOB.config.wikiurl][GLOB.using_map.name]/Corporate_Regulations&printable=yes&remove_links=1" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/solgov_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[GLOB.config.wikiurl]Sol_Central_Government_Law&printable=yes&remove_links=1" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/military_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[GLOB.config.wikiurl]Sol_Code_of_Military_Justice&printable=yes&remove_links=1" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/engineering_guide/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='100%' src="[GLOB.config.wikiurl]Guide_to_Engineering&printable=yes&remove_links=1" frameborder="0" id="main_frame"></iframe>		</body>
