...
GLOBAL_LIST_INIT(keyboard_sound, list('sound/machines/keypress1.ogg','sound/machines/keypress2.ogg','sound/machines/keypress3.ogg','sound/machines/keypress4.ogg'))
