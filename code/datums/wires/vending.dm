...
GLOBAL_VAR_CONST(VENDING_WIRE_THROW, 1)
GLOBAL_VAR_CONST(VENDING_WIRE_CONTRABAND, 2)
GLOBAL_VAR_CONST(VENDING_WIRE_ELECTRIFY, 4)
GLOBAL_VAR_CONST(VENDING_WIRE_IDSCAN, 8)
