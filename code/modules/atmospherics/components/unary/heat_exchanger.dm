/obj/machinery/atmospherics/unary/heat_exchanger
	...
	process()
		...
		if(!GLOB.air_master || GLOB.air_master.current_cycle <= update_cycle)
			return 0

		update_cycle = GLOB.air_master.current_cycle
		partner.update_cycle = GLOB.air_master.current_cycle
