...
/obj/item/weapon/rig/New()
	...
	if(glove_type)
		...
		GLOB.verbs |= /obj/item/weapon/rig/proc/toggle_gauntlets
	if(helm_type)
		helmet = new helm_type(src)
		GLOB.verbs |= /obj/item/weapon/rig/proc/toggle_helmet
	if(boot_type)
		boots = new boot_type(src)
		GLOB.verbs |= /obj/item/weapon/rig/proc/toggle_boots
	if(chest_type)
		chest = new chest_type(src)
		if(allowed)
			chest.allowed = allowed
		GLOB.verbs |= /obj/item/weapon/rig/proc/toggle_chest
