...
/datum/category_item/player_setup_item/player_global/settings/save_preferences(var/savefile/S)
	...
	to_save(S["preferences"], pref.preferences_enabled)
	to_save(S["preferences_disabled"], pref.preferences_disabled)
...
/datum/category_item/player_setup_item/player_global/settings/sanitize_preferences()
	...
	pref.default_slot	= sanitize_integer(pref.default_slot, 1, GLOB.config.character_slots, initial(pref.default_slot))
