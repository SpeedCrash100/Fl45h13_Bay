...
/datum/category_item/player_setup_item/general/background/load_character(var/savefile/S)
	...
	from_save(S["home_system"],pref.home_system)
	from_save(S["citizenship"],pref.citizenship)
	from_save(S["faction"],pref.faction)
	from_save(S["religion"],pref.religion)
	from_save(S["nanotrasen_relation"],pref.nanotrasen_relation)
...
/datum/category_item/player_setup_item/general/background/save_character(var/savefile/S)
	...
	to_save(S["home_system"],pref.home_system)
	to_save(S["citizenship"],pref.citizenship)
	to_save(S["faction"],pref.faction)
	to_save(S["religion"],pref.religion)
	to_save(S["nanotrasen_relation"],pref.nanotrasen_relation)
