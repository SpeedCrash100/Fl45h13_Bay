...
/datum/admin_secret_item/admin_secret/move_shuttle/execute(var/mob/user)
	...
	var/shuttle_tag = input(user, "Which shuttle do you want to jump?") as null|anything in GLOB.shuttle_controller.shuttles
	if (!shuttle_tag) return

	var/datum/shuttle/S = GLOB.shuttle_controller.shuttles[shuttle_tag]
