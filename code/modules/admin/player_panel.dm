...
/datum/admins/proc/check_antagonists()
	if (GLOB.ticker && GLOB.ticker.current_state >= GAME_STATE_PLAYING)
		...
		dat += "Current Game Mode: <B>[GLOB.ticker.mode.name]</B><BR>"
		...
		dat += "<a href='?src=\ref[src];delay_round_end=1'>[GLOB.ticker.delay_end ? "End Round Normally" : "Delay Round End"]</a><br>"
		dat += "<hr>"
