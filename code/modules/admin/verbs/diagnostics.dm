/client/proc/air_report()
	...
	if(!GLOB.master_controller || !GLOB.air_master)
		alert(usr,"Master_controller or air_master not found.","Air Report")
		return

	var/active_groups = GLOB.air_master.active_zones
	var/inactive_groups = GLOB.air_master.zones.len - active_groups
	...
	for(var/zone/zone in GLOB.air_master.zones)
...
<B>General Processing Data</B><BR>
	Cycle: [GLOB.air_master.current_cycle]<br>
	Groups: [GLOB.air_master.zones.len]<BR>
...
<B>Geometry Processing Data</B><BR>
	Tile Update: [GLOB.air_master.tiles_to_update.len]<BR>
"}
...
/client/proc/radio_report()
	...
	for (var/fq in GLOB.radio_controller.frequencies)
		output += "<b>Freq: [fq]</b><br>"
		var/list/datum/radio_frequency/fqs = GLOB.radio_controller.frequencies[fq]
		if (!fqs)
			output += "&nbsp;&nbsp;<b>ERROR</b><br>"
			continue
...
/client/proc/jump_to_dead_group()
	...
	for(var/datum/air_group/group in GLOB.air_master.air_groups)
