...
/obj/singularity/proc/toxmob()
	...
	GLOB.radiation_repository.radiate(src, radiation) //Always radiate at max, so a decent dose of radiation is applied
...
/obj/singularity/proc/smwave()
	for(var/mob/living/M in view(10, src.loc))
		if(prob(67))
			...
			M.dust()
	GLOB.radiation_repository.radiate(src, rand(energy))
	return
