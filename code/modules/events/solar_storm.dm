...
/datum/event/solar_storm/announce()
	GLOB.command_announcement.Announce("A solar storm has been detected approaching the [station_name()]. Please halt all EVA activites immediately and return inside.", "[station_name()] Sensor Array", new_sound = GLOB.using_map.radiation_detected_sound)
...
/datum/event/solar_storm/start()
	GLOB.command_announcement.Announce("The solar storm has reached the [station_name()]. Please refain from EVA and remain inside until it has passed.", "[station_name()] Sensor Array")
...
/datum/event/solar_storm/end()
	GLOB.command_announcement.Announce("The solar storm has passed the [station_name()]. It is now safe to resume EVA activities. Please report to medbay if you experience any unusual symptoms. ", "[station_name()] Sensor Array")
	adjust_solar_output()
