...
/obj/machinery/power/supermatter/proc/explode()
	...
	for(var/z in affected_z)
		GLOB.radiation_repository.z_radiate(locate(1, 1, z), DETONATION_RADS, 1)
...
/obj/machinery/power/supermatter/process()
	...
	GLOB.radiation_repository.radiate(src, power * 1.5) //Better close those shutters!
...
/obj/machinery/power/supermatter/proc/Consume(var/mob/living/user)
	...
	var/rads = 500
	GLOB.radiation_repository.radiate(src, rads)
