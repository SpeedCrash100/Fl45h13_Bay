...
/obj/machinery/portable_atmospherics/hydroponics/proc/weed_invasion()
	...
	if(seed) seed = null
	seed = GLOB.plant_controller.seeds[pick(list("reishi","nettles","amanita","mushrooms","plumphelmet","towercap","harebells","weeds"))]
...
/obj/machinery/portable_atmospherics/hydroponics/proc/mutate(var/severity)
	...
	if(!isnull(GLOB.plant_controller.seeds[seed.name]))
		seed = seed.diverge()
...
/obj/machinery/portable_atmospherics/hydroponics/proc/mutate_species()
	...
	if(newseed in GLOB.plant_controller.seeds)
		seed = GLOB.plant_controller.seeds[newseed]
	else
		return
