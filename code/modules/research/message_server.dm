...
/obj/machinery/blackbox_recorder/proc/round_end_data_gathering()
	...
	feedback_add_details("radio_usage","GLOB.COM-[msg_common.len]")
	feedback_add_details("radio_usage","GLOB.SCI-[msg_science.len]")
	feedback_add_details("radio_usage","HEA-[msg_command.len]")
	feedback_add_details("radio_usage","MED-[msg_medical.len]")
	feedback_add_details("radio_usage","GLOB.ENG-[msg_engineering.len]")
	feedback_add_details("radio_usage","GLOB.SEC-[msg_security.len]")
	feedback_add_details("radio_usage","DTH-[msg_deathsquad.len]")
	feedback_add_details("radio_usage","SYN-[msg_syndicate.len]")
	feedback_add_details("radio_usage","CAR-[msg_cargo.len]")
	feedback_add_details("radio_usage","GLOB.SRV-[msg_service.len]")
...
/obj/machinery/blackbox_recorder/proc/save_all_data_to_sql()
	...
	var/DBQuery/query = GLOB.dbcon.NewQuery("SELECT MAX(round_id) AS round_id FROM erro_feedback")
	query.Execute()
	while(query.NextRow())
