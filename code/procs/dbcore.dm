...
/*
GLOBAL_VAR_INIT(DB_SERVER, "") // This is the location of your MySQL server (localhost is USUALLY fine)
GLOBAL_VAR_INIT(DB_PORT, 3306) // This is the port your MySQL server is running on (3306 is the default)
*/
...
DBConnection/proc/Connect(dbi_handler=src.dbi,user_handler=src.user,password_handler=src.password,cursor_handler)
	...
	if(.)
		NewQuery("SET NAMES utf8mb4 COLLATE utf8mb4_general_ci").Execute()
