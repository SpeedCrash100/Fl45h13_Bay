/proc/register_radio(source, old_frequency, new_frequency, radio_filter)
	if(old_frequency)
		GLOB.radio_controller.remove_object(source, old_frequency)
	if(new_frequency)
		return GLOB.radio_controller.add_object(source, new_frequency, radio_filter)

/proc/unregister_radio(source, frequency)
	if(GLOB.radio_controller)
		GLOB.radio_controller.remove_object(source, frequency)
